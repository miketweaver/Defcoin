...
Then, to tunnel a SSL connection on 21335 to a RPC server bound on localhost on port 19334 do:

    stunnel -d 21335 -r 127.0.0.1:19334 -p stunnel.pem -P ''
...
caching. A sample config for apache2 could look like:
    ...
    <Location /defcoinrpc>
        ProxyPass http://127.0.0.1:1335/
        ProxyPassReverse http://127.0.0.1:1335/
