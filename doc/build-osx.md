...
5.  Installation into user directories (optional):
    ...
    or
        ...
        cd ~/defcoin/src
        cp defcoind /usr/local/bin/
        cp defcoin-cli /usr/local/bin/
...
The first time you run defcoind, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
