...
- The `rpcallowip` option can no longer be used to automatically listen
  ...
  [...] -p 127.0.0.1:1335:1335` (this is an extra `:1335` over the
...
in DFC per kilobyte, not tangoshi per byte.
...
- #1335 Let wallet `importmulti` RPC accept labels for standard scriptPubKeys (ryanofsky)
