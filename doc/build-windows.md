...
for Ubuntu Xenial does not produce working executables for some of the Defcoin Core applications.
...
The next three steps are an example of how to acquire the source in an appropriate way.
    ...
    cd /usr/src
    sudo git clone https://github.com/NaH012/defcoin.git
    sudo chmod -R a+rw defcoin
...
causes two of the defcoin executables to crash shortly after start up. The bug is related to the
...
It's not possible to build the defcoin code using the win32 version of the Mingw-w64 cross compilers (at least not without
modifying headers in the defcoin source code).
