...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s defcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  defcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded defcoin transaction") + "\n" +
              "  defcoin-tx [options] -create [commands]   " + _("Create hex-encoded defcoin transaction") + "\n" +
              "\n";
