...
static void SetupCliArgs()
{
    ...
    gArgs.AddArg("-rpcwallet=<walletname>", "Send RPC for non-default wallet on RPC server (needs to exactly match corresponding -wallet option passed to defcoind). This changes the RPC endpoint used, e.g. http://127.0.0.1:1335/wallet/<walletname>", false, OptionsCategory::OPTIONS);
